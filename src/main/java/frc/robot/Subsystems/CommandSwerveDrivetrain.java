...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public CommandSwerveDrivetrain(
        ...
        try {
            robotConfig = RobotConfig.fromGUISettings(); // Takes config from Robot Config on Pathplanner
            // Settings
        } catch (Exception e) {
    ...
    private Matrix<N3, N1> calculateAdaptiveStdDevs(int tagCount, double avgDistance, ChassisSpeeds speeds) {
        ...
        double speedFactor = Math.hypot(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond) / 4.0; // suppose the speed
                                                                                                   // max=4m/s
    ...
    private Pose2d targetPose = new Pose2d(12.44, 2.95, Rotation2d.fromDegrees(65));
    ...
    public Command alignToPose(Pose2d targetPose) {
        return Commands.defer(
                () -> AutoBuilder.pathfindToPose(targetPose, constraints, 0.0), Set.of(this));
    }
